...
const state = {
  months: [
    ...
    { 'name': 'Janeiro', 'abrev': 'Jan', index: 1 },
    { 'name': 'Fevereiro', 'abrev': 'Fev', index: 2 },
    { 'name': 'Março', 'abrev': 'Mar', index: 3 },
    { 'name': 'Abril', 'abrev': 'Abr', index: 4 },
    { 'name': 'Maio', 'abrev': 'Mai', index: 5 },
    { 'name': 'Junho', 'abrev': 'Jun', index: 6 },
    { 'name': 'Julho', 'abrev': 'Jul', index: 7 },
    { 'name': 'Agosto', 'abrev': 'Ago', index: 8 },
    { 'name': 'Setembro', 'abrev': 'Set', index: 9 },
    { 'name': 'Outubro', 'abrev': 'Out', index: 10 },
    { 'name': 'Novembro', 'abrev': 'Nov', index: 11 },
    { 'name': 'Dezembro', 'abrev': 'Dez', index: 12 }
  ],
  currentMonth: 5,
  currentYear: 2019,
  transactions: [],
